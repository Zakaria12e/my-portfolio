...
interface KeyboardContextType {
  ...
  onVirtualKeyPress: ((keyCode: string) => void) | null;
}
...
export const Keyboard = ({
  ...
  return (
    <KeyboardProvider
      ...
      onVirtualKeyPress={onVirtualKeyPress ?? null}
    >
      <div
        ref={containerRef}
        className={cn(
...
const Key = ({
  ...
  const { playSoundDown, playSoundUp, pressedKeys, setPressed, setReleased, onVirtualKeyPress } =
    useKeyboardSound();
